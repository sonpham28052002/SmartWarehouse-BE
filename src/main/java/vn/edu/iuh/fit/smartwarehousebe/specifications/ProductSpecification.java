...
public class ProductSpecification {
    ...
    public static Specification<Product> hasCode(String code) {
        return Optional.ofNullable(code)
                .map(c -> (Specification<Product>) (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("code"), c))
                .orElse(null);
    }
    ...
    public static Specification<Product> hasSku(String sku) {
        return Optional.ofNullable(sku)
                .map(s -> (Specification<Product>) (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("sku"), s))
                .orElse(null);
    }

    public static Specification<Product> hasSupplierId(Long supplierId) {
        return Optional.ofNullable(supplierId)
                .map(id -> (Specification<Product>) (root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get("supplier").get("id"), id))
                .orElse(null);
    }
